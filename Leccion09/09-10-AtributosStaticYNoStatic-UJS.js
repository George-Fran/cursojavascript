class Persona{
    ...
    email = "noname@gmail.com"; // atributo de nuestros objetos
...
console.log(Persona.contadorObjetosPersona); // solo podemos accedes a nuestra variable estatica mediante una clase
